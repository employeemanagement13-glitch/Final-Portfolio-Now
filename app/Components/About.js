...
export default function AboutSection() {
  const specialties = [
    ...
    },
    {
      ...
      description: 'Proficient in MERN, PERN and Next.js.',
      image: '/fullstack.png',
    },
    {
    ...
    >
      <div className="max-w-6xl mx-auto flex flex-col items-center">
        ...
        <p className="text-gray-100 mb-4 w-full sm:w-[90%] md:w-[75%] text-base sm:text-lg">
          <strong>Full Stack Web Developer</strong> with 3+ years of experience building scalable web applications from front to back using modern JavaScript frameworks and cloud-native technologies.
        </p>
        <p className="text-gray-100 mb-10 w-full sm:w-[90%] md:w-[75%] text-base sm:text-lg">
          My expertise lies in transforming business requirements into efficient, production-ready web applications using PERN, MERN and Next.js.
        </p>
